...
<h3 id="ah1"><a href="#"><span id="ah1t">Geography</span></a></h3>
<div id="fragment-1">
Find employers by:
<div id="rg">
<input type="radio" id="rg1" name="rg" checked="checked" /><label for="rg1">Area</label>
<input type="radio" id="rg2" name="rg" /><label for="rg2">Address</label>
</div>
</br/>
...
<div id="nearestselect" style="display: none">
Street address:<br/>
...
<br/><br/><input class="sbutn" type="submit"  value="Next&gt;" onclick="$('#thetabs').accordion('activate', 1); return false" />
</div>
<h3 id="ah2"><a href="#" ><span id="ah2t">Industries / Occupations</span></a></h3>
<div id="fragment-2">
       Search by:<br/>
       <div id="r">
...
<h3 id="ah3"><a href="#"  ><span id="ah3t">Employer Name</span></a></h3>
<div id="fragment-3">
...
<h3 id="ah4"><a href="#" ><span id="ah4t">Other Items</span></a></h3>
<div id="fragment-4">
